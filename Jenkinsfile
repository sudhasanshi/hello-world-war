pipeline {
    ...
    stages {
        ...
        stage('Helm Deploy') {
    steps {
        kubernetesDeploy configs: '', kubeConfig: [path: ''], kubeconfigId: 'eks-cluster', secretName: '', ssh: [sshCredentialsId: '*', sshServer: ''], textCredentials: [certificateAuthorityData: '', clientCertificateData: '', clientKeyData: '', serverUrl: 'https://']
         {
